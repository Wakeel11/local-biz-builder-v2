...
const Home = () => {
  ...
  return (
    <div className="pt-24 bg-gray-50">
      {/* 1. VIP HERO SECTION - FIXED ALIGNMENT */}
      ...
      <section className="py-20 bg-gray-50 border-b border-gray-200">
        <div className="container mx-auto px-4 text-center max-w-7xl">
          <h2 className="text-4xl font-black mb-12 uppercase text-[#1e3a8a] tracking-tight">Expert Local Service In:</h2>
        ...
        <div className="container mx-auto px-4 max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div>
            <h2 className="text-4xl font-black text-[#1e3a8a] mb-6 uppercase leading-tight italic">
              Your {niche.toUpperCase()} Authority in {primaryCity}
            </h2>
            <div className="text-gray-700 text-lg leading-relaxed mb-8 text-slate-600 font-medium">
              <p className="mb-6">
                Established in {BUSINESS_INFO.established}, we have dedicated ourselves to securing the homes and businesses of the {primaryCity} community. Speed and integrity are our core values.
              </p>
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                    <CheckCircle className="text-[#f97316] mt-1 flex-shrink-0" size={24} />
                    <span>Advanced leak detection and non-invasive diagnostics.</span>
                </li>
                <li className="flex items-start gap-3">
                    <CheckCircle className="text-[#f97316] mt-1 flex-shrink-0" size={24} />
                    <span>Serving the tri-state area with local pride.</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <div key={index} className="bg-white rounded-[30px] p-8 shadow-xl border-2 border-transparent hover:border-[#f97316] transition-all group flex flex-col text-left">
                ...
                <a href={`/services/${service.slug}`} className="inline-flex items-center gap-2 font-black text-[#f97316] uppercase tracking-widest text-sm group-hover:gap-4 transition-all">
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 text-center max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
            {[
              { name: "John D.", city: primaryCity, text: `Best emergency ${niche} service! Fixed our issue perfectly.` },
              { name: "Sarah M.", city: "Gurnee", text: "Professional team, upfront pricing. Highly recommended." },
