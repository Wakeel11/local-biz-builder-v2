...
export const SERVICES_DATA: Record<string, { title: string, content: string, image: string, intro: string }> = {
  ...
  // 1. EMERGENCY REPAIRS (URL: /services/emergency-repairs)
  "emergency-repairs": {
    ...
    intro: `Searching for emergency plumbing in waukegan? At ${BUSINESS_INFO.name}, we provide the rapid emergency plumbing service waukegan il homeowners trust. Our emergency plumber waukegan il team is available 24/7 for any plumbing emergency in Lake County, IL.`,
    content: `
      <div style="width: 100%; display: flex; flex-direction: column; gap: 0; font-family: sans-serif; color: #374151;">
        <section style="padding: 60px 10%; background-color: #ffffff; text-align: center;">
          ...
          <p style="line-height: 1.9; font-size: 1.2rem; margin: 0 auto 35px auto; max-width: 1050px;">
            When a plumbing emergency strikes your property, you need an emergency plumber near me open now who can arrive within the hour to mitigate damage. As a premier emergency plumbing company in Illinois, our team specializes in same-day plumbing service and 24 hour plumbing repair. We have established a reputation as the best <a href="/#/" style="color: #1e3a8a; text-decoration: underline;">emergency plumbing in waukegan</a> residents can rely on since our founding in 2016. Whether you face a leaking pipe emergency or need a water leak emergency plumber, we provide urgent plumbing repair across the entire Lake County region.
          </p>
          <div style="display: flex; justify-content: center;">
            <a href="tel:${BUSINESS_INFO.phone}" style="background-color: #22c55e; color: white; padding: 20px 50px; border-radius: 12px; font-size: 1.5rem; font-weight: 800; text-decoration: none; text-transform: uppercase; box-shadow: 0 4px 15px rgba(34, 197, 94, 0.3);">Call Emergency Plumber Now</a>
          </div>
        </section>
        <section style="padding: 60px 10%; background-color: #f8fafc; display: flex; flex-wrap: wrap; gap: 50px; align-items: center; border-top: 1px solid #eee; border-bottom: 1px solid #eee;">
          <div style="flex: 1; min-width: 350px;">
            ...
            <p style="margin-bottom: 30px; line-height: 1.7; font-size: 1.1rem;">
              Whether it is a water leak emergency plumber need or emergency water leak repair, our same day emergency plumber response secures your property instantly. We specialize in emergency pipe repair and leaking pipe emergency mitigation to prevent structural wood rot and foundation erosion.
            </p>
            <div style="display: flex; justify-content: center;">
        ...
        <section style="padding: 100px 10%; background-color: #ffffff;">
          <h2 style="font-size: 2.5rem; font-weight: 900; color: #1e3a8a; margin-bottom: 60px; text-align: center; text-transform: uppercase;">Emergency Plumbing Knowledge Hub</h2>
          ...
          <div style="margin-top: 80px; background: #fff5f5; padding: 60px; border-radius: 40px; border: 3px dashed #f56565; text-align: center;">
            ...
            <div style="display: flex; justify-content: center;">
              <a href="tel:${BUSINESS_INFO.phone}" style="background-color: #c53030; color: white; padding: 22px 65px; border-radius: 15px; font-size: 2rem; font-weight: 900; text-decoration: none; text-transform: uppercase;">Call Dispatch Now</a>
            </div>
          </div>
        </section>
      </div>
  ...
  // 2. DRAIN & SEWER CLEANING (URL: /services/drain-sewer-cleaning)
  ...
  // 3. WATER HEATER SERVICES (URL: /services/water-heater-services)
      ...
      <div style="width: 100%; display: flex; flex-direction: column; gap: 0; font-family: sans-serif; color: #374151;">
        ...
        <section style="padding: 100px 10%; background-color: #ffffff;">
          ...
          <div style="margin-top: 80px; background: #fff5f5; padding: 60px; border-radius: 40px; border: 3px dashed #f56565; text-align: center;">
            ...
            <div style="display: flex; justify-content: center;">
              <a href="tel:${BUSINESS_INFO.phone}" style="background-color: #c53030; color: white; padding: 22px 60px; border-radius: 12px; font-size: 1.8rem; font-weight: 900; text-decoration: none; text-transform: uppercase;">Call Now</a>
            </div>
          </div>
        </section>
      </div>
  ...
  // 4. SUMP PUMP PROTECTION (URL: /services/sump-pump-protection)
  ...
  // 5. ADVANCED LEAK DETECTION (URL: /services/advanced-leak-detection)
      ...
      <div style="width: 100%; display: flex; flex-direction: column; gap: 0; font-family: sans-serif; color: #374151;">
        ...
        <section style="padding: 100px 10%; background-color: #ffffff;">
          ...
          <div style="margin-top: 80px; background: #fff5f5; padding: 60px; border-radius: 40px; border: 3px dashed #f56565; text-align: center;">
            ...
            <div style="display: flex; justify-content: center;">
              <a href="tel:${BUSINESS_INFO.phone}" style="background-color: #dc2626; color: white; padding: 22px 60px; border-radius: 12px; font-size: 2rem; font-weight: 900; text-decoration: none; text-transform: uppercase;">Dispatch Leak Team</a>
            </div>
          </div>
        </section>
      </div>
  ...
  // 6. GAS LINE SERVICES (URL: /services/gas-line-services)
  "gas-line-services": {
